<?php
define('DB_DSN', 'mysql:dbname=epgrec_test;host=localhost;');
...
require_once dirname(__FILE__) . '/models/program.php';
require_once dirname(__FILE__) . '/models/reserve.php';
require_once dirname(__FILE__) . '/models/keyword.php';
require_once dirname(__FILE__) . '/models/recorder_service.php';

require_once dirname(__FILE__) . '/models/channel_master.php';
